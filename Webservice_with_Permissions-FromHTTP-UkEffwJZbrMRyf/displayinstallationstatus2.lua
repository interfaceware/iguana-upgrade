...
function display.main(R, A)
   ...
   <script language="javascript">
      function fetch(version) {
         document.getElementById("loading-"+version).innerHTML = "<img src=\"http://devops.ifware/~sripley/spinner.gif\"/>";
         $.ajax({
            type: 'GET',
            url: '/update/fetch?version='+version,
            error: function() {
               location.reload();
            },
